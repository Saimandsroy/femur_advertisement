          ...
          <AnimatePresence mode="wait">
            ...
            {currentStep === 4 && (
              ...
              >
                ...
                <p className="text-gray-400 mb-8">
                  We'll use this information to create your custom strategy and schedule a consultation call.
                </p>
            ...
            {currentStep === 5 && (
              ...
              >
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-3xl font-bold text-white mb-4">Schedule Your Strategy Call</h2>
                  <p className="text-xl text-gray-300 mb-6">
                    Perfect! Now let's schedule a 30-minute strategy call to discuss your project in detail.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-2xl overflow-hidden" style={{ height: "600px" }}>
                  <iframe
                    src="https://calendly.com/mohan-motionrecords"
                    width="100%"
                    height="100%"
                    frameBorder="0"
                ...
                <div className="text-center mt-6">
                  <p className="text-gray-400 text-sm">
                    ...
                    <a href="mailto:mohan@motionrecords.co" className="text-blue-400 hover:text-blue-300">
                      mohan@motionrecords.co
                    </a>
                  </p>
                </div>
              </motion.div>
          ...
          {currentStep < 5 && (
            <div className="flex justify-between items-center mt-8">
              ...
              <div>
                ...
                >
                  {currentStep === 4 ? "Schedule Call" : "Continue"}
