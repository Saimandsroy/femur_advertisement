    ...
    <footer className="relative bg-black border-t border-gray-800/50">
      ...
      {/* <div className="relative z-10 border-b border-gray-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          >
            <h3 className="text-3xl sm:text-4xl font-bold text-white mb-4">Ready to Scale Your Marketing?</h3>
          ...
          >
            ...
            {isSubscribed && <p className="text-green-400 text-center mt-4 animate-fade-in">Thanks for subscribing!</p>}
          </motion.form>
        </div>
      </div> */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
            ...
            <div className="group flex justify-center lg:justify-start">
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 rounded-xl overflow-hidden">
                  <img 
                    src="/femur logo.jpg" 
                    alt="Femur Studio Logo" 
                    className="w-full h-full object-cover"
                  />
                </div>
                <span className="text-white font-bold text-3xl tracking-tight">FEMUR</span>
              </div>
            </div>
            <p className="text-gray-400 text-lg leading-relaxed max-w-md mx-auto lg:mx-0">
              Empowering businesses to achieve remarkable growth through strategic marketing, innovative campaigns, and
              data-driven results that drive real ROI.
            </p>

            {/* Social Links */}
            <div className="flex space-x-6 justify-center lg:justify-start">
              {[
                { icon: Instagram, href: "https://www.instagram.com/femurstudio/", label: "Instagram" },
                { icon: Twitter, href: "https://x.com/femurstudio", label: "Twitter" },
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center sm:text-left">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h4 className="text-lg font-semibold text-white mb-6">Marketing Services</h4>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 text-gray-400 justify-center sm:justify-start">
                  ...
                  <span>femurstudioio@gmail.com</span>
                </div>
        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 text-center sm:text-left">
            <p className="text-gray-500 text-sm">
              © {new Date().getFullYear()} Femur Marketing Agency. All rights reserved.
            </p>
            <div className="flex space-x-6 text-sm">
              <Link href="/legal#privacy" className="text-gray-500 hover:text-white transition-colors">
                Privacy Policy
              </Link>
